  ...
  const cardsData = [
    {
      ...
      title: "Distribución",
      info: "Si necesita de un proveedor estable, eficiente y eficaz que responda en tiempo y forma para realizar la distribución y el traslado de su mercadería, correo interno y/o insumos, ya sea entre sus clientes, proveedores o bien entre las distintas plantas si de una empresa se trata. Para ello diseñamos un servicio de distribución que cumpla con sus expectativas a través de la información que Ud. nos brinde y nuestra experiencia en el campo logístico.",
    },
    {
    ...
    },
    {
      ...
      title: "Redespacho",
      info: "Este Servicio se implementa para poder llevar su mercadería a los transportes o expresos con los que su empresa se maneja habitualmente para envíos al interior del país.  Se realiza en el día, con retiro y entrega a domicilio garantizando la seguridad de su envío y su arribo a destino.",
    },
    {
    ...
    },
    {
      ...
      info: "Los envíos que contengan “mercaderías” con un valor determinado podrán ser asegurados durante todo el trayecto: desde el retiro hasta la entrega al destinatario.",
    },
    {
      icon: <img src="img/services/inversa.png" className={styles.imgIcon}></img>,
      title: "Logística Inversa",
      info: "Gestionamos el retorno de productos y devoluciones de manera eficiente, reduciendo costos y mejorando la satisfacción del cliente.",
    },
  ];
